...
class TestCreate:
    ...
    INVALID_FIELD_DATA = {
        ...
        'lat_nad27__invalid_value':    (delete_mods('id') + set_mods('lat_nad27', value=Decimal(99.0)), ValueError),
        ...
        'long_nad27__invalid_value':   (delete_mods('id') + set_mods('long_nad27', value=Decimal(189.0)), ValueError),

        'lat_nad27__given__long_nad27__not_given': (delete_mods('id', 'long_nad27') + set_mods('lat_nad27', value=Decimal(90.0)), ValueError),
        'lat_nad27__given__long_nad27__NoneType':  (delete_mods('id') + set_mods('lat_nad27', value=Decimal(90.0)) + set_none_mods('long_nad27'), ValueError),
        'lat_nad27__not_given__long_nad27__given': (delete_mods('id', 'lat_nad27') + set_mods('long_nad27', value=Decimal(180.0)), ValueError),
        'lat_nad27__NoneType__long_nad27_given':   (delete_mods('id') + set_none_mods('lat_nad27') + set_mods('long_nad27', value=Decimal(180.0)), ValueError),
        ...
        'lat_nad83__invalid_value':    (delete_mods('id') + set_mods('lat_nad83', value=Decimal(99.0)), ValueError),
        ...
        'long_nad83__invalid_value':   (delete_mods('id') + set_mods('long_nad83', value=Decimal(189.0)), ValueError),

        'lat_nad83__given__long_nad83__not_given': (delete_mods('id', 'long_nad83') + set_mods('lat_nad83', value=Decimal(90.0)), ValueError),
        'lat_nad83__given__long_nad83__NoneType':  (delete_mods('id') + set_mods('lat_nad83', value=Decimal(90.0)) + set_none_mods('long_nad83'), ValueError),
        'lat_nad83__not_given__long_nad83__given': (delete_mods('id', 'lat_nad83') + set_mods('long_nad83', value=Decimal(180.0)), ValueError),
        'lat_nad83__NoneType__long_nad83_given':   (delete_mods('id') + set_none_mods('lat_nad83') + set_mods('long_nad83', value=Decimal(180.0)), ValueError),
        ...
        'x_nad27__given__y_nad27__not_given': (delete_mods('id', 'y_nad27') + set_mods('x_nad27', value=Decimal(22.0)), ValueError),
        'x_nad27__given__y_nad27__NoneType':  (delete_mods('id') + set_mods('x_nad27', value=Decimal(22.0)) + set_none_mods('y_nad27'), ValueError),
        'x_nad27__not_given__y_nad27__given': (delete_mods('id', 'x_nad27') + set_mods('y_nad27', value=Decimal(22.0)), ValueError),
        'x_nad27__NoneType__y_nad27_given':   (delete_mods('id') + set_none_mods('x_nad27') + set_mods('y_nad27', value=Decimal(22.0)), ValueError),
        ...
        'x_nad83__given__y_nad83__not_given': (delete_mods('id', 'y_nad83') + set_mods('x_nad83', value=Decimal(22.0)), ValueError),
        'x_nad83__given__y_nad83__NoneType':  (delete_mods('id') + set_mods('x_nad83', value=Decimal(22.0)) + set_none_mods('y_nad83'), ValueError),
        'x_nad83__not_given__y_nad83__given': (delete_mods('id', 'x_nad83') + set_mods('y_nad83', value=Decimal(22.0)), ValueError),
        'x_nad83__NoneType__y_nad83_given':   (delete_mods('id') + set_none_mods('x_nad83') + set_mods('y_nad83', value=Decimal(22.0)), ValueError),
